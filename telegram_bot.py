...
Uses direct HTTP to Gemini API (no SDK)
"""
...
def extract_from_image(image_bytes):
    ...
    logger.info(f"Gemini HTTP status: {r.status_code}")
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Gemini returned unexpected format. Try again.")
